...
import { DafnyGraphTool } from "../../tool/dafny/graph_tool"
import { DafnyVerifyTool } from "../../tool/dafny/verify"
import { DafnyImpactTool } from "../../tool/dafny/impact_tool"
...
function dafnyImpact(info: ToolProps<typeof DafnyImpactTool>) {
  block(
    {
      icon: "!",
      title: "Impact",
...
function dafnyVerify(info: ToolProps<typeof DafnyVerifyTool>) {
  block(
    {
      icon: "✓",
      title: "Dafny Verify",
...
function dafnyGraph(info: ToolProps<typeof DafnyGraphTool>) {
  block(
    {
      icon: "≈",
      title: "Dafny Graph",
    ...
    async function execute(sdk: OpencodeClient) {
      function tool(part: ToolPart) {
        try {
          ...
          if (part.tool === "dafny_graph") return dafnyGraph(props<typeof DafnyGraphTool>(part))
          if (part.tool === "dafny_verify") return dafnyVerify(props<typeof DafnyVerifyTool>(part))
          if (part.tool === "dafny_impact") return dafnyImpact(props<typeof DafnyImpactTool>(part))
