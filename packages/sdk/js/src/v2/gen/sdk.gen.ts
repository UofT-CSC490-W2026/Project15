...
export class Session extends HeyApiClient {
     ...
     * Run tool
     *
     * Execute a tool directly in a session and return the tool output.
     */
    public tool<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        directory?: string;
        agent?: string;
        model?: {
...
export class Dafny extends HeyApiClient {
    /**
     * Get Dafny status
     *
     * Get the verification status of all Dafny files in the project.
     */
    public status<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }] }]);
        return (options?.client ?? this.client).get<DafnyStatusResponses, unknown, ThrowOnError>({
            url: '/dafny',
            ...options,
            ...params
        });
    ...
    /**
     * Get Dafny dependency graph
     *
     * Get the dependency graph of all Dafny files.
     */
    public graph<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }] }]);
        return (options?.client ?? this.client).get<DafnyGraphResponses, unknown, ThrowOnError>({
            url: '/dafny/graph',
            ...options,
            ...params
        });
     ...
     * Verify Dafny files
     *
     * Run Dafny verification on specified files or all files.
     */
    public verify<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        ...
        return (options?.client ?? this.client).post<DafnyVerifyResponses, DafnyVerifyErrors, ThrowOnError>({
            url: '/dafny/verify',
            ...options,
            ...params,
            headers: {
    ...
    /**
     * Check impact of file change
     *
     * Check which files would be affected by editing a specific file.
     */
    public impact<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        filePath?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'body', key: 'filePath' }] }]);
        return (options?.client ?? this.client).post<DafnyImpactResponses, DafnyImpactErrors, ThrowOnError>({
            url: '/dafny/impact',
            ...options,
            ...params,
            headers: {
...
export class OpencodeClient extends HeyApiClient {
    ...
    private _dafny?: Dafny;
    get dafny(): Dafny {
        return this._dafny ??= new Dafny({ client: this.client });
    }
