...
export type EventLspClientDafnyGutter = {
    type: 'lsp.client.dafny.gutter';
    properties: {
        path: string;
...
export type DafnyStatusResponses = {
    /**
     * Dafny project status
     */
    200: unknown;
};

export type DafnyGraphData = {
    body?: never;
    path?: never;
    query?: {
        directory?: string;
...
export type DafnyGraphResponses = {
    /**
     * Dafny dependency graph
     */
    200: unknown;
};

export type DafnyVerifyData = {
    body?: {
...
export type DafnyVerifyError = DafnyVerifyErrors[keyof DafnyVerifyErrors];

export type DafnyVerifyResponses = {
    /**
...
export type DafnyImpactError = DafnyImpactErrors[keyof DafnyImpactErrors];

export type DafnyImpactResponses = {
    /**
     * Impact analysis
     */
    200: unknown;
